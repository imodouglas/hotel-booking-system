<?php
    if(!isset($_GET['id'])){ header("Location: index.php"); } else { $id = $_GET['id']; }
    include 'scss/classes.php';

    $eventData = getEvent($conn,$id);
    ...
    if(isset($_POST['regEvent'])){
        ...
        $msg2 = "Hello Admin! You have a new registration for ".$eventData['eventName'].". \r\n\r\nPlease see details below:\r\nName: ".$_POST['fullName']."\r\nEmail: ".$_POST['email']."\r\nPhone No.: ".$_POST['phoneNo'].". \r\n\r\nPlease cross-check details with paystack to confirm payment status.\r\n\r\nFrom: Event Registration Form";

        mail($_POST['email'], $eventData['eventName']." Registation", $msg1, "FROM: booking@caesarsbytlc.com");
        mail("booking@caesarsbytlc.com", "New ".$eventData['eventName']." Registation", $msg2, "FROM: booking@caesarsbytlc.com");

        if($eventData['eventPrice'] == "FREE"){ echo "<script> alert('Registration was successful, thank you!.'); window.location = 'event.php?id=".$id."'; </script>"; } else {
            header("Location: ?id=".$id."&step=2#payment");
        }
    }
...
<head>
    <meta charset="utf-8">
    <!-- TITLE -->
    <title><?php echo $eventData['eventName']; ?> | The Lekki Coliseum</title>
            ...
            <div class="sub-banner">
                <div class="container">
                    <div class="text text-center">
                        ...
                        <p>From <?php echo date("d M", $eventData['eventStart']); ?> to <?php echo date("d M", $eventData['eventEnd']); ?></p>
                    </div>
                </div>
                ...
                <div class="about">
                    ...
                    <div class="about-item">
                        ...
                        <div class="img owl-single">
                            <img src="images/<?php echo $eventData['eventImg']; ?>" alt="">
                        </div>

                        <div class="text" style="margin-top:20px">
                            <div style="margin-bottom:10px"><?php echo nl2br($eventData['eventDesc']); ?></div>
                            <div class="desc" align="left">
                                ...
                                <form method="post" action="">
                                    ...
                                    <p align="left">
                                        <label> Event/Deal Name: </label>
                                        <input type="text" name="event" value="<?php echo $eventData['eventName']; ?>" class="form-control" readonly />
                                    </p>
                                    <p align="left">
                                ...
                                <?php } else if(isset($_GET['step']) && $_GET['step'] == 2){ ?>
                                    ...
                                    <form action="reservation-step-4.php" method="GET" >
                                        <script
                                            ...
                                            data-amount="<?php echo $eventData['eventPrice']."00.00"; ?>" 

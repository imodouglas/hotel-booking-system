...
if(isset($_GET['paystack-trxref'])){
  if($_GET['paystack-trxref'] == $_SESSION['rand']){
    ...
    if($actRes){
      ...
      $mail = ($_SESSION['ResEmail'], "Successful payment notification!", $msg, "FROM: info@thelekkicoliseum.com");
                            ...
                            <div class="reservation_content">
                              <?php if(!isset($_GET['payment'])){ ?>
                                <div class="reservation-chosen-message bg-gray text-center">
                                    ...
                                    <p><?php echo "Dear ".$getReservations['firstName']." ".$getReservations['lastName'].", see below your reservation overview."; ?> </p>
                                    <?php if($getReservations['resStatus'] !== "approved"){ ?>
                                      <p>
                                        <?php echo $getReservations['description'].". <br /><br /> Please make payment of the sum of <strong>N".number_format($getReservations['amount'],0)."</strong> to the account number below within 12hours to prevent cancelation of your reservation. <br /><br /> Colliseum Courts Cencepts Limited <br />FCMB (USD) - 2130575026<br />FCMB (Naira) - 2130575040<br />Diamond/Access (Naira) - 0083271321"; ?>
                                      </p>
                                    <?php } else { ?>
                                      <p>
                                        <?php echo $getReservations['description'].". <br /> Thank you for choosing us, we look forward to giving you a lush experience. <br /><strong>Please copy your reservation number for verification purpose on arrival.</strong>"; ?>
                                      </p>
                                    <?php } ?>
                              ...
                              <?php } else if(isset($_GET['payment']) && $_GET['payment'] == "card") { ?>
                                <div class="reservation-chosen-message bg-gray text-center">
                                    ...
                                    <p><?php echo "Dear ".$getReservations['firstName']." ".$getReservations['lastName'].", see below your reservation overview."; ?> </p>
                                    <p>
                                      <?php echo $getReservations['description'].". <br /> Please make payment of the sum of <strong>N".number_format($getReservations['amount'],0)."</strong> with your debit/credit card by clicking the button below."; ?>
                                    </p>
                                    <p>
                                      <?php
                                      ...
                                      <form action="transaction.php" method="GET" >
                                        <script
                                          ...
                                          data-amount="<?php echo $getReservations['amount']."00"; ?>"
